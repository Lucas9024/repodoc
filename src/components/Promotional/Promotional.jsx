...
const Promotional = () => {
  return (
    <div className='container w-[100%]'>
      ...
      <h1 className='text-center text-blackWhite text-3xl mx-auto sm:3xl lg:3xl md:2xl  font-bold pt-10  pb-5'>CONSULTAS SIMPLES E ACESSÍVEIS PARA TODAS AS FAMÍLIAS</h1>
...
<div className=''>
 ...
 <img src={promotional} className='promo absolute object-contain mt-[-30px] pb-[40px] mr-[380px] hidden md:block' />
                ...
                <h1 className=' text-white   text-2xl sm:1xl lg:4xl md:2xl font-semibold'>Para 4 Pessoas </h1>
                 ...
                 <img src={promooff} className='promo absolute object-contain mt-[-30px] pb-[40px] ml-[350px] hidden md:block' />
                
                </div>

  <div className='flex justify-around mx-auto bg-white'>
  <h1 className='text-center text-primary text-3xl mx-auto sm:3xl lg:3xl md:2xl  font-bold pt-4  pb-5'>CONFIRA OS BENEFÍCIOS</h1>
...
<h2 className='w-[300px] text-blackText text-left font-semibold '>7 dias por semana</h2>
  ...
  <div className='flex justify-around mx-auto bg-gradient-to-r from-primary to-greenLight'>
    <h1 className=' text-white text-2xl sm:2xl lg:4xl  font-bold pt-5  pb-5 '>Consultas com Médicos Especialistas</h1>
...
<h2 className='w-[300px] text-blackText text-left font-semibold '>Orientações para uma vida mais saudável</h2>
...
<h2 className='w-[350px] text-blackText text-left font-semibold '>Pedidos de exames, receitas, atestados médicos e encaminhamentos válidos em todo Brasil</h2>
</div>
  ...
  <div className='bg-white'>
  <h1 className='text-center text-primary text-3xl mx-auto sm:3xl lg:3xl md:2xl  font-bold pt-4  pb-5'>INCLUA ATÉ MAIS 3 DEPENDENTES</h1>
    <hr className=' container w-[90%] text-gray' />
  ...
  <div className='text-center items-center mx-auto bg-white pb-5'>
    ...
    <button className='text-white text-1xl font-bold bg-greenLight rounded-full w-[90%] p-3 uppercase hover:bg-primary duration-[100ms] btn-pulse'>
    Clínico Geral
    7 Dias Grátis
